...
api_key = 'eaa8261510b105a611f2db34487b74e9'
...
get_weather_button = tk.Label(frame, text='GET WEATHER', fg='green', font=('Helvetica', 10, 'bold'), bg='white')
get_weather_button.grid(row=1, column=0, columnspan=2, pady=5)
get_weather_button.bind('<Button-1>', lambda event: get_weather_info())
